...
sampling_frequency=2000 #sampling frequency
...
gui = cf.pre_processing_gui(emgfile=emgfile,mvc=mvc,increase_rate=increase_rate,steady_time=steady_time,resting_time=resting_time,sampling_frequency=sampling_frequency)